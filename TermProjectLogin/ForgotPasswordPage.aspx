...
<asp:Content ID="Content2" ContentPlaceHolderID="cphContent" runat="server">
    ...
    <asp:Button ID="btnCheckEmail" CssClass="btn btn-info" runat="server" OnClick="btnCheckEmail_Click" Text="Check Email" />
    ...
    <asp:Panel ID="pnQuestion" runat="server" Visible="false">
        ...
        <asp:Button ID="btnSubmit" CssClass="btn btn-info" runat="server" Text="Submit Answer" OnClick="btnSubmit_Click" />
    </asp:Panel>
