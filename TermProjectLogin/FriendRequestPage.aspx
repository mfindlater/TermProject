...
<asp:Content ID="Content2" ContentPlaceHolderID="cphContent" runat="server">
    ...
    <asp:GridView ID="gvIncomingFriendRequests" runat="server" AutogenerateColumns="False">
        <Columns>
           <asp:TemplateField>
               <ItemTemplate>
                   <asp:ImageButton ID="imgIProfile" runat="server" ImageUrl='<%# Bind("ProfilePhotoURL") %>' Width="70px" Height="100px" OnClick="imgIProfile_Click"/>
               </ItemTemplate>
            </asp:TemplateField>
    ...
    <asp:GridView ID="gvOutgoingFriendRequests" runat="server" AutoGenerateColumns="False">
           ...
           <asp:TemplateField>
               <ItemTemplate>
                   <asp:ImageButton ID="imgOProfile" runat="server" ImageUrl='<%# Bind("ProfilePhotoURL") %>' Width="70px" Height="100px" OnClick="imgOProfile_Click"/>
               </ItemTemplate>
            </asp:TemplateField>
                <asp:BoundField DataField="Name" HeaderText="Name" />
                <asp:BoundField DataField="FriendRequestStatus" HeaderText="Status" />
